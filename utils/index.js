...
module.exports.throwError = function (command, threadID, messageID) {
	...
	return global.client.api.sendMessage(`[!] » Dùng lệnh cũng ngu :) vui lòng sử dụng ${(threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : global.config.PREFIX}help ${command} để biết thêm hướng dẫn sử dụng bot hoặc liên hệ Admin Bot : https://www.facebook.com/Admin.HoangAnh.Booking`, threadID, messageID);
}
